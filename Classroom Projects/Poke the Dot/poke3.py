...
class Game:
   ...
   def draw_game_over(self):
      string = 'Game Over'
      # Incorrect way
      # fg_color = self.small_dot.color # violation of SW quality requirements Section 7.2
      # bg_color = self.big_dot.color # violation of SW quality requirements Section 7.2
      
      # Reason
      # class is a black box
      # class encapsulates the bahavior and properties ofa  group of objects
   ...
   def draw_score(self):
      ...
      location = (0,0)
      # drawing score in the top right corner of the window
      #y = 0
...
class Dot:
   ...
   def get_color(self):
      # getting method
      # returns the isntance attribute color
      return self.color
   
   def set_color(self,new_color):
      # setter method that sets the value of an instance attribute
   ...
   def randomize(self):
      size = self.surface.get_size() # get size is a method in pygame.Surface class
      # self.surface is an object of type pygame
      # Surface size is of type tuple (width,height)
      # size[0] -- width
      # size[1] -- height
      
      for i in range(0,2):
         self.center[i] = random.randint(self.radius,size[i] - self.radius)# random value
